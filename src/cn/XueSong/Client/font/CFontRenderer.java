...
public class CFontRenderer extends CFont {
    ...
    public int getStringWidthCust(String text) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((String.valueOf(character).equals("°Ï")) && (i < size)) {
                int colorIndex = "0123456789abcdefklmnor".indexOf(character);
    ...
    public static float DisplayFontWithShadow(String str, float x, float y, int color) {
       //str=" "+str;
        ...
        for(int iF = 0; iF < str.length(); ++iF) {
            ...
            if (s.contains("°Ï") && iF + 1 <= str.length()) {
        ...
        if (getStringWidth(text) > width) {
            ...
            for (String word : words) {
                for (int i = 0; i < word.toCharArray().length; i++) {
                    ...
                    if ((String.valueOf(c).equals("°Ï")) && (i < word.toCharArray().length - 1)) {
    ...
    public List<String> formatString(String string, double width) {
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            if ((String.valueOf(c).equals("°Ï")) && (i < chars.length - 1))//Why does intelij replace "°Ï" with °Ï
            {
