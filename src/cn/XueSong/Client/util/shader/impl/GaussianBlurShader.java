...
import cn.XueSong.Client.util.shader.base.CShader;
...
import cn.XueSong.Client.util.shader.kernel.GaussianKernel;
...
public class GaussianBlurShader extends CShader {

    private final CShaderProgram blurProgram = new CShaderProgram("blur.frag", "vertex.vsh");
