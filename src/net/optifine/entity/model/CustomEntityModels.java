...
public class CustomEntityModels
{
    ...
    public static void update()
    {
        ...
        if (map == null)
        {
            Config.warn("Entity RenderA map not found, custom entity models are DISABLED.");
        }
        else if (map1 == null)
        {
            Config.warn("Tile entity RenderA map not found, custom entity models are DISABLED.");
        }
        else
        {
            active = false;
