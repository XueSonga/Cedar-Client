...
public abstract class Entity implements ICommandSender
{
     ...
     * RenderA if ignoreFrustumCheck or in frustum.
     */
    ...
    /**
     * Checks if the entity is in range to RenderA by using the past in distance and comparing it to its average edge
    ...
    /**
     * Returns true if the entity is on fire. Used by RenderA to add the fire effect on rendering.
     */
    ...
    /**
     * Returns true if the entity is riding another entity, used by RenderA to rotate the legs to be in 'sit' position
     * for players.
     */
     ...
     * For EntityLivingBase subclasses, returning false when invisible will RenderA the entity semitransparent.
     */
    ...
    /**
     * Set the RenderA yaw offset
     *  
     * @param offset The RenderA yaw offset
     */
