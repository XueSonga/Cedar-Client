...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, double xPosition, double yPosition, String text)
    {
        if (stack != null)
        {
            if (stack.stackSize != 1 || text != null)
            {
                ...
                GlStateManager.disableBlend();
                CFontRenderer.DisplayFontWithShadow(s,(float)(xPosition + 19 - 2 - fr.getStringWidth(s)),(float)(yPosition + 6 + 3),16777215);
     ...
     * @param width The width of the RenderA
     * @param height The height of the RenderA
