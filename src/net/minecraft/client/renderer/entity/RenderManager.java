...
public class RenderManager
{
     ...
     *
     * @param x X position where to RenderA the debug bounding box
     * @param y Y position where to RenderA the debug bounding box
     * @param z Z position where to RenderA the debug bounding box
