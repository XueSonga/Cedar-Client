...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            if (!list.isEmpty())
            {
                while (true)
                {
                    this.splashText = Client.NAEM+" 版本:"+Client.VERSION;
    ...
    public void initGui()
    {
        ...
        {
            this.field_92023_s = font_A.getStringWidth(this.openGLWarning1);
            this.field_92024_r = font_A.getStringWidth(this.openGLWarning2);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        f = f * 100.0F / (float)(font_A.getStringWidth(this.splashText) + 32);
        GlStateManager.scale(f, f, f);
        this.drawCenteredString(this.fontRendererObj, this.splashText, 0, -8, new Color(0, 252, 54,255).getRGB());
        GlStateManager.popMatrix();
        String s = Client.NAEM+" | "+Client.VERSION + " 开发测试版";
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists())
        {
            ...
            for (int l1 = 0; l1 < list.size(); ++l1)
            {
                ...
                {
                    CFontRenderer.DisplayFontWithShadow(s1, 2, this.height - (10 + l1 * (this.fontRendererObj.FONT_HEIGHT + 1)), new Color(0, 252, 54,255).getRGB());
                }
            }
        ...
        {
            CFontRenderer.DisplayFontWithShadow( s, 2, this.height - 10, -1);
        }

        String s2 = "Client By 雪松 QQ:3474075823";
        CFontRenderer.DisplayFontWithShadow(s2, this.width - font_A.getStringWidth(s2), this.height - 10, new Color(255, 196, 0,255).getRGB());

        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            drawRect(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2, this.field_92019_w - 1, new Color(0, 252, 54,255).getRGB());
            CFontRenderer.DisplayFontWithShadow( this.openGLWarning1, this.field_92022_t, this.field_92021_u, -1);
            CFontRenderer.DisplayFontWithShadow( this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((GuiButton)this.buttonList.get(0)).yPosition - 12, -1);
        }
