...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            CFontRenderer.DisplayFontWithShadow(ingestserver.serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
            CFontRenderer.DisplayFontWithShadow(s, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.font_A.getStringHeight("A")+ 5 + 3, 3158064);
            CFontRenderer.DisplayFontWithShadow(s1, this.getScrollBarX() - 5 - GuiIngestServers.font_A.getStringWidth(s1), p_180791_3_ + 5, 8421504);

            if (s2 != null)
            {
                CFontRenderer.DisplayFontWithShadow(s2, this.getScrollBarX() - 5 - GuiIngestServers.font_A.getStringWidth(s2), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
