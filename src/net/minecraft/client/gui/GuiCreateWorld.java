...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.inMoreWorldOptionsDisplay)
        {
            CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.enterSeed", new Object[0]), this.width / 2 - 100, 47, -6250336);
            CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.seedInfo", new Object[0]), this.width / 2 - 100, 85, -6250336);

            if (this.btnMapFeatures.visible)
            {
                CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.mapFeatures.info", new Object[0]), this.width / 2 - 150, 122, -6250336);
            }

            if (this.btnAllowCommands.visible)
            {
                CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.allowCommands.info", new Object[0]), this.width / 2 - 150, 172, -6250336);
            }
        ...
        {
            CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.enterName", new Object[0]), this.width / 2 - 100, 47, -6250336);
            CFontRenderer.DisplayFontWithShadow(I18n.format("selectWorld.resultFolder", new Object[0]) + " " + this.saveDirName, this.width / 2 - 100, 85, -6250336);
            this.worldNameField.drawTextBox();
            CFontRenderer.DisplayFontWithShadow(this.gameModeDesc1, this.width / 2 - 100, 137, -6250336);
            CFontRenderer.DisplayFontWithShadow(this.gameModeDesc2, this.width / 2 - 100, 149, -6250336);
        }
