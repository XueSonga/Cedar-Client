...
public class GuiScreenHorseInventory extends GuiContainer
{
    ...
    {
        CFontRenderer.DisplayFontWithShadow(this.horseInventory.getDisplayName().getUnformattedText(), 8, 6, 4210752);
        CFontRenderer.DisplayFontWithShadow(this.playerInventory.getDisplayName().getUnformattedText(), 8, this.ySize - 96 + 2, 4210752);
    }
