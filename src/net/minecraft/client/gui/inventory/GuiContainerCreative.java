...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs.drawInForegroundOfTab())
        {
            ...
            CFontRenderer.DisplayFontWithShadow(I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]), 8, 6, 4210752);
        }
    }
    ...
    /**
     * Renders the creative inventory hovering text if mouse is over it. Returns true if did RenderA or false otherwise.
