...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void initStream()
    {
        ...
        catch (Throwable throwable)
        {
            ...
            logger.error("无法启动twitch直播(中国人就要播中国人的直播)");
        }
    }
     ...
     *  
     * @param posX X position for the RenderA
     * @param posY Y position for the RenderA
     * @param texU X position for the texture
     * @param texV Y position for the texture
     * @param width Width of the RenderA
     * @param height Height of the RenderA
     * @param red The red component of the RenderA's color
     * @param green The green component of the RenderA's color
     * @param blue The blue component of the RenderA's color
     * @param alpha The alpha component of the RenderA's color
     */
    ...
    private void runGameLoop() throws IOException
    {
        ...
        this.checkGLError("Pre RenderA");
        this.mcProfiler.endStartSection("sound");
        this.mcSoundHandler.setListener(this.thePlayer, this.timer.renderPartialTicks);
        this.mcProfiler.endSection();
        this.mcProfiler.startSection("RenderA");
        ...
        this.mcProfiler.endSection();
        this.mcProfiler.endSection();
        this.checkGLError("Post RenderA");
        ++this.fpsCounter;
